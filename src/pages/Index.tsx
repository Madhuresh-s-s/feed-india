  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=1920')] bg-cover bg-center mix-blend-overlay opacity-30" />
        
        {/* Floating Elements */}
        <div className="absolute top-20 right-10 w-64 h-64 rounded-full bg-secondary/20 blur-3xl animate-float" />
        <div className="absolute bottom-20 left-10 w-48 h-48 rounded-full bg-primary-foreground/10 blur-2xl animate-float" style={{ animationDelay: "2s" }} />
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-xl gradient-hero mx-auto mb-4 flex items-center justify-center shadow-soft">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-accent group-hover:gradient-hero transition-all duration-300 flex items-center justify-center mb-6">
      ...
      <section className="py-24 gradient-warm">
        <div className="container mx-auto px-4">
          <div className="bg-card rounded-3xl p-8 md:p-16 shadow-elevated relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 rounded-full gradient-hero opacity-10 blur-3xl" />
            <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-secondary/20 blur-2xl" />
